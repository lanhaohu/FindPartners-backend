...
import com.dex.FindPartners.mapper.FriendsMapper;
import com.dex.FindPartners.model.domain.Friends;
...
import static com.dex.FindPartners.contant.FriendConstant.*;
...
public class FriendsServiceImpl extends ServiceImpl<FriendsMapper, Friends> implements FriendsService {
    ...
    public boolean addFriendRecords(User loginUser, FriendAddRequest friendAddRequest) {
        ...
        RLock lock = redissonClient.getLock("FindPartners:apply");
        try {
            // 抢到锁并执行
