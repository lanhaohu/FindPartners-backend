...
import com.dex.FindPartners.model.request.UserLoginRequest;
import com.dex.FindPartners.model.request.UserQueryRequest;
import com.dex.FindPartners.model.request.UserRegisterRequest;
...
//        return new BaseResponse<>(0,result,"ok");
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        String redisKey = String.format("FindPartners:user:recommend:%s", loginUser.getId());
